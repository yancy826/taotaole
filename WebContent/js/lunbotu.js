	...
	for(var i = 0; i < buttons.length; i++) {
		(function(i) {
			buttons[i].onclick = function() {
				...
				var offset = 250 * (index - clickIndex); //这个index是当前图片停留时的index
				animate(offset);
...
function fun2() {
	...
	var buttons = document.getElementById('buttons2').getElementsByTagName('span');
...
function fun3() {
	...
	var buttons = document.getElementById('buttons3').getElementsByTagName('span');
